...
//inspired by http://forum.jquery.com/topic/width-includes-border-width-when-set-to-thin-medium-thick-in-ie
        ...
        this.updateScrollBar = function(len) {
            if (self.ishwscroll) {
                ...
                if (!self.locked){
                    if($("#content_bodyText")[0]!="" && $("#content_bodyText")[0]!=undefined){
                        //pos.left=$("#content_bodyText").css("margin-left");
                    }
...
//
        ...
        this.showCursor = function(py,px) {
            ...
            //self.cursor.css({height:"39px",top:self.scroll.y});
            if (self.cursorh) {
