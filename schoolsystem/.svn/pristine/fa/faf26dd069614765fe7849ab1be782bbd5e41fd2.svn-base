            ...
            <el-form ref="form" label-width="100px">
              ...
              <el-form-item label="审批意见：">
                <el-row class="approvalOpinion">
                  <el-input type="textarea" resize="none" max="100" placeholder="请输入审批意见" v-model="recordMsg.opinion"></el-input>
                  <p class="limitNum"><span>{{recordMsg.opinion.length}}</span><span>/100</span></span></p>
                </el-row>
                <el-select v-model="recordMsg.use" placeholder="常用审批意见" style="width:100%;">
