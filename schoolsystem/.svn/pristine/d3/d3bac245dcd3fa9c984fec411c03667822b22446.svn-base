  ...
  <div class="g-statisticalAnalysis g-container">
    ...
    <section class="centerTable alertsList">
      ...
      <el-table class="g-NotHover" :data="classesTimeSetTable" @sort-change="sortChange" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="报修物品" prop="name"></el-table-column>
        ...
        <el-table-column label="操作" fixd="right">
          <template scope="props">
            <el-button v-if="false" type="text">接单</el-button>
            <el-button @click="handlerTaskClick" v-else class="deleteColor" type="text">处理任务</el-button>
          </template>
        </el-table-column>
      </el-table>
    </section>
