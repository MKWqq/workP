<template>
  <div class="ExpressLane">
    ...
    <el-col :span="24">
      ...
      <el-dialog title="添加链接" size="tiny" v-if="dialogTableVisibleother" :modal="false" :visible.sync="dialogTableVisibleother">
        <el-col style="min-height: 20rem;">
          ...
          <el-col :span="24" style="margin-top: 2rem;">
            <el-col :span="5" :offset="2" style="padding-top: .4rem;">网站链接：</el-col>
            <el-col :span="15">
              <el-input placeholder="请输入"></el-input>
            </el-col>
          </el-col>
...
<style lang="less">
  ...
  .ExpressLane  .CreateProcess-top-btn{
    padding:.5rem 2.8rem ;
    border-radius: 1.1rem;
    cursor: pointer;
  }
 .ExpressLane  .Field-save{
    position: absolute;
    bottom: 1rem;
    padding: .5rem 2.1rem;
    border-radius: 1.1rem;
