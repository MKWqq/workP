<template>
    <div class="pendingApproval">
      <el-row type="flex" align="middle" class="studyingWayApproval_row">
        <el-button type="primary" class="uploadTemplate" @click="changeState(0)">审批通过</el-button>
        <el-button type="danger" class="uploadTemplate" @click="changeState(1)">审批不通过</el-button>
        <div class="warmHint">
          <el-col :span="2" class="notes">备注：</el-col>
          <el-col :span="22">
            <el-row>审批通过：原申请住校的学生转为住校页面的数据，原申请走读的学生转为走读页面的数据。</el-row>
            <el-row>审批不通过：原申请住校的学生转为走读页面的数据，原申请走读的学生转为住校页面的数据</el-row>
          </el-col>
        </div>
      </el-row>
