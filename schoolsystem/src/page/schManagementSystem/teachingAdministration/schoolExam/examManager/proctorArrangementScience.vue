<template>
  <div class="proctorArrangementScience">
    <el-row>
      <el-button type="primary" class="return_btn" @click="returnFlowchart"><img
        src="../../../../../assets/img/schManagementSystem/teachingAdministration/schoolExam/icon_return.png"
        alt=""><span class="returnTxt">返回流程图</span></el-button>
      <span class="breadcrumb"><router-link to="/examManagerHome/proctorArrangementArts" tag="span">文科</router-link><span>|</span><span class="breadcrumb_active">理科</span></span>
    </el-row>
...
<style>
  .proctorArrangementScience .el-button.select{
    padding:10px 25px;
  }
  .proctorArrangementScience .proctor_rules{
    width:16rem;
  }
  .proctorArrangementScience .el-table--border td{
    border-right:none;
  }
</style>
