  ...
  <div class="FileapprovalPending">
    ...
    <el-col :span="24" style="margin-top: 1.4rem">
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template scope="scope">
              ...
              <span style="color:#4da1ff;cursor: pointer;padding-left: .6rem" @click="Showaccessory(scope.row)">附件</span>
            </template>
          </el-table-column>
        </el-table>
      </el-row>
      ...
      <el-dialog title="档案审批"  v-if="showpending" :modal="false" :visible.sync="showpending">
        <el-col :span="24" style="text-align: center;min-height: 40rem;">
          <div class="LeaveRecord-table">
            <div class="LeaveRecord-dialog-title">#{{dialogData.title}}#</div>
            <el-col :span="24">
              <div class="LeaveRecord-table-div">
      ...
      <el-dialog title="编辑档案审批" v-if="showedit" :modal="false" :visible.sync="showedit">
        <el-col :span="22" :offset="1" class="FilerecordPending-add">
          ...
          <el-col :span="24" style="margin-top: 2rem;">
            ...
            <el-col :span="2" :offset="13">
              <el-button class="Field-save" @click="Offedit()">取消</el-button>
            </el-col>
          </el-col>
        </el-col>
      </el-dialog>
