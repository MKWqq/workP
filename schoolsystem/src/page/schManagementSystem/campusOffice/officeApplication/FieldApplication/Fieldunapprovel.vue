        ...
        <el-col :span="24" style="text-align: center;height:36rem;overflow-y:auto;">
          <div class="LeaveRecord-table">
            ...
            <el-col :span="24">
              ...
              <div class="LeaveRecord-table-div">
                <el-col :span="7">
                  <div class="LeaveRecord-table-div-1">场地负责人</div>
                </el-col>
                <el-col :span="17">
              ...
              <div class="LeaveRecord-table-div">
                <el-col :span="7">
                  <div class="LeaveRecord-table-div-1">场地申请人</div>
                </el-col>
                <el-col :span="17">
              ...
              <div class="LeaveRecord-table-div">
                <el-col :span="7">
                  <div class="LeaveRecord-table-div-1">场地使用人</div>
                </el-col>
                <el-col :span="17">
              ...
              <div class="LeaveRecord-table-div">
                <el-col :span="7">
                  <div class="LeaveRecord-table-div-1">联系电话</div>
                </el-col>
                <el-col :span="17">
              ...
              <div class="LeaveRecord-table-div">
                <el-col :span="7">
                  <div class="LeaveRecord-table-div-1">使用时间</div>
                </el-col>
                <el-col :span="17">
                  <div>{{dialogData.reason}}</div>
                </el-col>
