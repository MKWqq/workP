<template>
  <div class="FieldSet">
    ...
    <el-col :span="24">
      ...
      <el-dialog title="添加选项" size="tiny" v-if="dialogTableVisible" :modal="false" :visible.sync="dialogTableVisible">
        <el-col style="min-height: 10rem;">
          <el-col :span="24">
            <el-col :span="5" :offset="2" style="padding-top: .5rem;">选项名称：</el-col>
            <el-col :span="15">
              <el-input
                class="input-new-tag"
                v-model="inputValue"
      ...
      <el-dialog title="添加配置" size="tiny" v-if="dialogTableVisibleother" :modal="false" :visible.sync="dialogTableVisibleother">
        <el-col style="min-height: 10rem;">
          <el-col :span="24">
            <el-col :span="5" :offset="2" style="padding-top: .5rem;">场地名称：</el-col>
            <el-col :span="15">
              <el-input></el-input>
            </el-col>
          </el-col>
