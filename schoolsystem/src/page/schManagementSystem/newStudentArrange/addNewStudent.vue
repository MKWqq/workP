      ...
      <el-form class="g-form_twoColumn" :model="dataForm" label-width="120px">
        ...
        <div class="g-form-row g-liOneRow">
          ...
          <el-form-item label="现住地址:">
            <el-cascader :options="options2" :props="city_prop" @change="getCity_one"></el-cascader>
          </el-form-item>
        </div>
        <div class="g-form-row g-liOneRow">
        ...
        <div class="g-form-row g-liOneRow">
          ...
          <el-form-item label="指标生出档:">
            <el-switch on-text="是" off-text="否"></el-switch>
          </el-form-item>
        </div>
      </el-form>
      <div class="g-footer">
