  ...
  <div class="g-classSchedule">
    <header class="g-timeHeader g-flexStartRow">
      ...
      <ul class="changeRouter selfCenter clear_fix">
        <li class="activeCss" data-msg="reportWait" @click="changeRouterClick">待处理</li>
        <li class="normalCss" data-msg="reportProcessed" @click="changeRouterClick">已维修</li>
        <li class="normalCss" data-msg="reportAccepted" @click="changeRouterClick">已验收</li>
      </ul>
    </header>
