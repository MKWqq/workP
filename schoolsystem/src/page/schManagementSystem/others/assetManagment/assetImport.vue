    ...
    <section class="g-section">
      ...
      <div class="gs-table alertsList">
        <el-table ref="studentMsgTable" :data="headerButtonData.studentBasicMsg" style="width:100%" @sort-change="sortChange" @selection-change="handleStudentTable">
          ...
          <el-table-column label="资产名称" sortable></el-table-column>
          <el-table-column label="分类代码"></el-table-column>
          <el-table-column label="业务名称" sortable></el-table-column>
          <el-table-column label="业务日期" sortable></el-table-column>
          <el-table-column label="供应商" sortable></el-table-column>
          <el-table-column label="规格" sortable></el-table-column>
          <el-table-column label="单位" sortable></el-table-column>
          <el-table-column label="品牌型号" sortable></el-table-column>
          <el-table-column label="单位(元)" sortable></el-table-column>
          <el-table-column label="数量" sortable></el-table-column>
        </el-table>
      </div>
    </section>
