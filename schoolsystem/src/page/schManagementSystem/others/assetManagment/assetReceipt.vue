  ...
  <div class="g-classSchedule">
    <header class="g-timeHeader g-flexStartRow">
      ...
      <ul class="changeRouter selfCenter clear_fix">
        <li class="activeCss" data-msg="newReceipt" @click="changeRouterClick">新增领用</li>
        <li class="normalCss" data-msg="ReceiptRecord" @click="changeRouterClick">领用记录</li>
        <li class="normalCss" data-msg="returnRecord" @click="changeRouterClick">归还记录</li>
      </ul>
    </header>
