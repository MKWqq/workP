        ...
        <el-table class="g-NotHover" :data="newStoragetable" @selection-change="handleSelectionChange" @sort-change="sortChange">
          ...
          <el-table-column label="操作" fixed="right">
            <template scope="props">
              <el-button type="text" @click="isDialog=true">出库</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
      <el-dialog class="headerNotBackground" title="出库" :modal="false" :visible.sync="isDialog" size="tiny" :before-close="handlerClose">
