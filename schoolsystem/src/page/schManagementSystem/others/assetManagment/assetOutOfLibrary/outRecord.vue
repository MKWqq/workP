  ...
  <div class="g-container">
      ...
      <div class="g-liOneRow g-sa_header_search">
        <div class="gs-button alertsBtn">
          <el-button-group>
            ...
            <el-button class="filt buttonChild" title="撤毁">
              <img class="filt_unactive"  src="../../../../../assets/img/schManagementSystem/baseSettings/userManager/teacher/ic_destroy_n.png" />
              <img class="filt_active" src="../../../../../assets/img/schManagementSystem/baseSettings/userManager/teacher/ic_destroy_highlight.png" />
            </el-button>
          </el-button-group>
        </div>
    ...
    <section class="centerTable alertsList">
      <el-table class="g-NotHover" :data="classesTimeSetTable" @selection-change="handleSelectionChange" @sort-change="sortChange">
        ...
        <el-table-column label="入库日期"></el-table-column>
        ...
        <el-table-column label="操作" width="150" fixed="right">
          <template scope="props">
            ...
            <el-button type="text" class="deleteColor">撤毁</el-button>
